...
const Detalles3 = () => {
  ...
  const [denuncia, setDenuncia] = useState({
    folio: location.state?.folio || "910-511",  // Usamos el folio pasado desde ConsultarEstado
    name: "Gael Carbajal",
    date: "10/10/2024",
    location: "Calle C, #789",
    description: "Reporto las placas CL-9377, que chocaron mi coche esta tarde.",
    category: "Autos",
