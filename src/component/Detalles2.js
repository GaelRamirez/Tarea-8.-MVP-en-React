...
const Detalles2 = () => {
  ...
  const [denuncia, setDenuncia] = useState({
    folio: location.state?.folio || "156-456",  // Usamos el folio pasado desde ConsultarEstado
    name: "Gonzalo González",
    date: "05/10/2024",
    location: "Calle B, #456",
    description: "Reporto que en la calle están obstrullendo la banqueta con un camión de carga.",
    category: "Autos",
